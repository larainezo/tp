...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withRoomNumber("WO-02-25").withTelegram("bensonMeier").withBirthday("25/02/2001")
            .withEmail("johnd@example.com").withPhone("98765432").withFreeTimeTags("Mon:1000-1400")
            .withFreeTime("Mon:1000-1400").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withRoomNumber("IW-03-12").withTelegram("carlKurz")
            .withBirthday("12/04/1995").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withRoomNumber("an-10-10").withTelegram("danielMeier")
            .withBirthday("10/10/2002").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822243")
            ...
            .withBirthday("14/02/1999").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94822427")
            ...
            .withBirthday("12/05/2002").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("94824142")
            ...
            .withBirthday("22/12/1997").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84821311")
            ...
            .withBirthday("09/09/1998").withFreeTimeTags("Mon:1000-1400").withFreeTime("Mon:1000-1400").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withBirthday(VALID_BIRTHDAY_AMY).withFreeTimeTags(VALID_FREE_TIME_TAG_AMY)
            .withFreeTime(VALID_FREE_TIME_TAG_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withRoomNumber(VALID_ROOMNUMBER_BOB).withTelegram(VALID_TELEGRAM_BOB)
            .withBirthday(VALID_BIRTHDAY_BOB).withFreeTimeTags(VALID_FREE_TIME_TAG_BOB)
            .withFreeTime(VALID_FREE_TIME_TAG_BOB).build();
